...
$content = <<<HTML
[vc_row css=".vc_custom_academia006{padding-top:64px !important;padding-bottom:44px !important;background-color:#f7f7f5 !important;}"][vc_column width="1/1"][vcex_heading text="A course catalogue people can actually search." tag="h2" font_size="46px" text_align="center" bottom_margin="20px" font_weight="700"][vc_column_text css=".vc_custom_academia001{text-align:center !important;font-size:18px !important;}"]Academia is a free WordPress block theme for schools, universities, academies and online course providers. Courses filter, search and sort without reloading the page — and they still filter correctly with JavaScript switched off. Pick one of six starter sites and you have a finished site you can take apart in the Site Editor without touching code.[/vc_column_text][vc_column_text css=".vc_custom_academia002{text-align:center !important;margin-top:26px !important;}"][vc_btn title="Download Academia" style="flat" color="green" link="url:{$download}|title:Download%20Academia|target:_blank" css=".vc_custom_academia003{display:inline-block !important;vertical-align:middle !important;margin-right:12px !important;margin-bottom:10px !important;}" i_icon_fontawesome="fa fa-download" add_icon="true"][vc_btn title="Live demo" style="flat" color="grey" link="url:{$demo}|title:Live%20demo|target:_blank" css=".vc_custom_academia004{display:inline-block !important;vertical-align:middle !important;margin-right:12px !important;margin-bottom:10px !important;}" i_icon_fontawesome="fa fa-eye" add_icon="true"][vc_btn title="Documentation" style="flat" color="grey" link="url:{$docs}|title:Documentation|target:_blank" css=".vc_custom_academia005{display:inline-block !important;vertical-align:middle !important;margin-right:12px !important;margin-bottom:10px !important;}" i_icon_fontawesome="fa fa-book" add_icon="true"][/vc_column_text][/vc_column][/vc_row][vc_row css=".vc_custom_academia007{padding-top:0px !important;padding-bottom:64px !important;background-color:#f7f7f5 !important;}"][vc_column width="1/1"][vcex_image image_id="{$hero_img}" align="center" border_radius="14px" bottom_margin="0px"][/vc_column][/vc_row]
...
[vc_row css=".vc_custom_academia010{padding-top:44px !important;padding-bottom:20px !important;background-color:#f7f7f5 !important;}"][vc_column width="1/1"][vcex_heading text="Courses, however you keep them" tag="h2" font_size="34px" text_align="center" bottom_margin="14px" font_weight="700"][vc_column_text css=".vc_custom_academia011{text-align:center !important;}"]Academia reads courses from whatever your site already has, and renders all of them with the same card design.[/vc_column_text][/vc_column][/vc_row][vc_row css=".vc_custom_academia012{padding-bottom:44px !important;background-color:#f7f7f5 !important;}"][vc_column width="1/3"][vcex_icon_box style="one" heading="Academia Library" icon="fa fa-graduation-cap" icon_color="#0f766e" heading_size="19px"]Our free companion plugin adds a Course content type with levels, durations, lesson counts, prices, instructors and ratings — and upgrades the browser so filtering and sorting happen without a page load.[/vcex_icon_box][/vc_column][vc_column width="1/3"][vcex_icon_box style="one" heading="Your existing LMS" icon="fa fa-plug" icon_color="#0f766e" heading_size="19px"]Already running Tutor LMS, LifterLMS, Sensei or LearnDash? Academia reads their courses and maps their fields onto the same cards. Nothing to migrate.[/vcex_icon_box][/vc_column][vc_column width="1/3"][vcex_icon_box style="one" heading="Just your posts" icon="fa fa-file-text-o" icon_color="#0f766e" heading_size="19px"]With no plugin at all, courses fall back to posts in a category called “courses”. Fewer details on the card, and the theme still works on a bare install.[/vcex_icon_box][/vc_column][/vc_row]
...
[vc_row css=".vc_custom_academia040{padding-top:44px !important;padding-bottom:20px !important;background-color:#f7f7f5 !important;}"][vc_column width="1/1"][vcex_heading text="What else is in it" tag="h2" font_size="34px" text_align="center" bottom_margin="24px" font_weight="700"][/vc_column][/vc_row][vc_row css=".vc_custom_academia041{padding-bottom:20px !important;background-color:#f7f7f5 !important;}"][vc_column width="1/3"][vcex_icon_box style="one" heading="Light and dark" icon="fa fa-adjust" icon_color="#0f766e" heading_size="18px"]A visitor-facing toggle that lifts the active palette rather than replacing it, so a green site stays green in the dark. Every text colour meets WCAG AA in both schemes — measured, not asserted.[/vcex_icon_box][/vc_column][vc_column width="1/3"][vcex_icon_box style="one" heading="Eight palettes, five typefaces" icon="fa fa-paint-brush" icon_color="#0f766e" heading_size="18px"]Colour and typography change independently, so any of the 40 combinations is one click in Appearance → Editor → Styles.[/vcex_icon_box][/vc_column][vc_column width="1/3"][vcex_icon_box style="one" heading="No external requests" icon="fa fa-bolt" icon_color="#0f766e" heading_size="18px"]Six self-hosted variable fonts, no Google Fonts, no jQuery, and no JavaScript library of any kind. Images ship as AVIF.[/vcex_icon_box][/vc_column][/vc_row][vc_row css=".vc_custom_academia042{padding-bottom:44px !important;background-color:#f7f7f5 !important;}"][vc_column width="1/3"][vcex_icon_box style="one" heading="Your courses stay yours" icon="fa fa-unlock" icon_color="#0f766e" heading_size="18px"]The Course content type belongs to the plugin, not the theme, so changing theme leaves your catalogue intact and editable. No hostages.[/vcex_icon_box][/vc_column][vc_column width="1/3"][vcex_icon_box style="one" heading="Your forms, styled" icon="fa fa-envelope-o" icon_color="#0f766e" heading_size="18px"]Contact sections render whichever of ten form plugins you already use. A theme must not process submissions, so Academia never does.[/vcex_icon_box][/vc_column][vc_column width="1/3"][vcex_icon_box style="one" heading="WooCommerce ready" icon="fa fa-shopping-cart" icon_color="#0f766e" heading_size="18px"]Shop, product, cart, checkout and confirmation templates, with the product grid's columns set explicitly so they do not collapse.[/vcex_icon_box][/vc_column][/vc_row]
...
echo 'demo links: ' . substr_count( $saved, 'colorlibhub.com/academia' ) . "\n";
echo 'docs links: ' . substr_count( $saved, 'docs.colorlib.com/academia' ) . "\n";
echo 'counted downloads: ' . substr_count( $saved, 'updates.colorlib.com/download/theme/academia.zip' ) . "\n";
