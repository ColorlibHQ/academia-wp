...
<h2 class="wp-block-heading academia-footer-heading has-base-color has-text-color has-small-font-size">Our school</h2>
<!-- /wp:heading -->
...
<div class="wp-block-column academia-footer-col">
<!-- wp:heading {"className":"academia-footer-heading","textColor":"base","fontSize":"small"} -->
<h2 class="wp-block-heading academia-footer-heading has-base-color has-text-color has-small-font-size">Parents</h2>
<!-- /wp:heading -->
<!-- wp:list {"className":"academia-footer-links"} -->
<ul class="wp-block-list academia-footer-links">
<!-- wp:list-item -->
...
<div class="wp-block-column academia-footer-col">
<!-- wp:heading {"className":"academia-footer-heading","textColor":"base","fontSize":"small"} -->
<h2 class="wp-block-heading academia-footer-heading has-base-color has-text-color has-small-font-size">Visit</h2>
<!-- /wp:heading -->
<!-- wp:list {"className":"academia-footer-links"} -->
<ul class="wp-block-list academia-footer-links">
<!-- wp:list-item -->
