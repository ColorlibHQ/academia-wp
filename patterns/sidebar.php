...
/**
 * Title: Sidebar
 * Slug: academia/sidebar
 * Categories: academia_utility
...
<div class="wp-block-group">
	...
	<div class="wp-block-group">
		...
		<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Search', 'academia' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group">
		<!-- wp:heading {"level":2,"fontSize":"large"} -->
		<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Recent posts', 'academia' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group">
		<!-- wp:heading {"level":2,"fontSize":"large"} -->
		<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Topics', 'academia' ); ?></h2>
		<!-- /wp:heading -->
	...
	<div class="wp-block-group is-style-card" style="border-radius:20px;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--50)">
		<!-- wp:heading {"level":2,"fontSize":"large"} -->
		<h2 class="wp-block-heading has-large-font-size"><?php esc_html_e( 'Try Academia free', 'academia' ); ?></h2>
		<!-- /wp:heading -->
		<!-- wp:paragraph {"textColor":"muted","fontSize":"small"} -->
		<p class="has-muted-color has-text-color has-small-font-size"><?php esc_html_e( 'Fourteen days of the Team plan. No card, no sales call.', 'academia' ); ?></p>
		<!-- /wp:paragraph -->
		<!-- wp:buttons -->
		<div class="wp-block-buttons">
			<!-- wp:button {"width":100} -->
			<div class="wp-block-button has-custom-width wp-block-button__width-100"><a class="wp-block-button__link wp-element-button" href="#"><?php echo esc_html_x( 'Start free trial', 'Button text', 'academia' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
