...
<h2 class="wp-block-heading has-base-color has-text-color has-small-font-size">Study</h2>
<!-- /wp:heading -->
<!-- wp:list -->
...
<div class="wp-block-column">
<!-- wp:heading {"textColor":"base","fontSize":"small"} -->
<h2 class="wp-block-heading has-base-color has-text-color has-small-font-size">About</h2>
<!-- /wp:heading -->
<!-- wp:list -->
<ul class="wp-block-list">
<!-- wp:list-item -->
...
<div class="wp-block-column">
<!-- wp:heading {"textColor":"base","fontSize":"small"} -->
<h2 class="wp-block-heading has-base-color has-text-color has-small-font-size">Apply</h2>
<!-- /wp:heading -->
<!-- wp:list -->
<ul class="wp-block-list">
<!-- wp:list-item -->
