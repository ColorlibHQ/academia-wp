 ...
 * Slug: academia/footer-university
...
<p class="academia-footer-note has-small-font-size">A teaching and research institution, awarding degrees since 1897.</p>
<!-- /wp:paragraph -->
<?php endif; ?>
<!-- wp:html -->
...
<h2 class="wp-block-heading academia-footer-heading has-base-color has-text-color has-small-font-size">Study</h2>
<!-- /wp:heading -->
<!-- wp:list {"className":"academia-footer-links"} -->
<ul class="wp-block-list academia-footer-links">
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Undergraduate', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Postgraduate', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Research degrees', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Short courses', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
</ul>
<!-- /wp:list -->
</div>
...
<div class="wp-block-column academia-footer-col">
<!-- wp:heading {"className":"academia-footer-heading","textColor":"base","fontSize":"small"} -->
<h2 class="wp-block-heading academia-footer-heading has-base-color has-text-color has-small-font-size">About</h2>
<!-- /wp:heading -->
<!-- wp:list {"className":"academia-footer-links"} -->
<ul class="wp-block-list academia-footer-links">
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'The university', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Faculties', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Research', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Campus', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
</ul>
<!-- /wp:list -->
</div>
...
<div class="wp-block-column academia-footer-col">
<!-- wp:heading {"className":"academia-footer-heading","textColor":"base","fontSize":"small"} -->
<h2 class="wp-block-heading academia-footer-heading has-base-color has-text-color has-small-font-size">Apply</h2>
<!-- /wp:heading -->
<!-- wp:list {"className":"academia-footer-links"} -->
<ul class="wp-block-list academia-footer-links">
<!-- wp:list-item -->
...
<!-- /wp:list-item -->
<!-- wp:list-item -->
<li><a href="#"><?php esc_html_e( 'Open days', 'academia' ); ?></a></li>
<!-- /wp:list-item -->
<!-- wp:list-item -->
