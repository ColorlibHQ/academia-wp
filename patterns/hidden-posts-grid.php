 ...
 * Slug: academia/hidden-posts-grid
 * Inserter: no
...
<div class="wp-block-query alignwide">
	...
	<!-- wp:post-template {"style":{"spacing":{"blockGap":"var:preset|spacing|50"}},"layout":{"type":"grid","columnCount":3}} -->
		...
		<div class="wp-block-group">
			...
			<!-- wp:post-excerpt {"moreText":"<?php echo esc_html_x( 'Read more', 'Post excerpt read more link', 'academia' ); ?>","excerptLength":20} /-->
		</div>
		<!-- /wp:group -->
	<!-- /wp:post-template -->
	...
	<!-- wp:query-no-results -->
		...
		<div class="wp-block-group">
			...
			<p class="has-text-align-center has-muted-color has-text-color"><?php esc_html_e( 'Nothing found. Try a different search term or browse the latest posts from the menu.', 'academia' ); ?></p>
			<!-- /wp:paragraph -->
